...
Diagnostics extends SectionEvaluationItem {
                ...
                add(new SectionCheckboxEvaluationItem(context, ConfigurationParams.EKG, context.getString(R.string.ekg), false, new ArrayList<EvaluationItem>() {
                    {
                        ...
                        add(new NumericalEvaluationItem(context, ConfigurationParams.PR_DURATION, context.getString(R.string.pr_duration), context.getString(R.string.value), 80, 400, false, true));
                        add(new NumericalEvaluationItem(context, ConfigurationParams.QRS_DURATION, "QRS duration", "Value", 80, 500, false, true));
                        ...
                        add(new BooleanEvaluationItem(context, ConfigurationParams.ATRIAL_FLUTTER, context.getString(R.string.atrial_flutter), false));
                ...
                add(new SectionCheckboxEvaluationItem(context, ConfigurationParams.ECHOCARDIOGRAPHY, context.getString(R.string.echocardiography), false, new ArrayList<EvaluationItem>() {
                    {
                        ...
                        add(new NumericalEvaluationItem(context, ConfigurationParams.EF, "LV EF %", "", 5, 80, false, true));
                        add(new NumericalEvaluationItem(context, ConfigurationParams.MP, "Mitral E/E'(average) ", "Value", 2, 30, false, true));
                        add(new NumericalEvaluationItem(context, ConfigurationParams.MITRAL_E_VARIATION, "Mitral E wave cm/s", "Value", 30, 300, false, true));
                        ...
                        add(new BooleanEvaluationItem(context, ConfigurationParams.E_A_LESS_05_AND_DT_MORE_280MS, "E/A less than or equal to 0.8", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.LV_ECCENTICITY, "E/A more than or equal to 2", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.GRADE_MORE_2_DIASTOLIC_DYSFUNCTION, "E/A less than 2 and more than 0.8", false));
                        ...
                        add(new NumericalEvaluationItem(context, ConfigurationParams.TRJ_VELOCITY, "TRJ velocity m/s", "", 1, 6, false));
                        ...
                        add(new BooleanEvaluationItem(context, ConfigurationParams.MIDSYS_NOTCH, "Enlarged RV", false));
                        add(new SectionCheckboxEvaluationItem(context, ConfigurationParams.PRIMARY_MITRAL_REGURGITATION, "Mitral Regurgitation", false, new ArrayList<EvaluationItem>() {
                        {


                            add(new NumericalEvaluationItem(context, ConfigurationParams.REGURGITANT_VOLUME_ML_BEAT, "Regurgitant volume mm", "", 5, 80, false, true));
                            add(new NumericalEvaluationItem(context, ConfigurationParams.REGURGITANT_FRACTION , "Regurgitant fraction % ", "Value", 2, 80, false, true));
                            add(new NumericalEvaluationItem(context, ConfigurationParams.ERO, "Effective regurgitant orifice", "Value", 0.01, 34, false, true));
                            add(new NumericalEvaluationItem(context, ConfigurationParams.LVED_ECHO, "LVED mm", "", 3, 15, false, true));
                        }
                        }));
